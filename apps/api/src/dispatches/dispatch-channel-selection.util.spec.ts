...
describe('dispatch-channel-selection.util', () => {
  ...
  it('nao realoca SENT DELIVERED READ UNKNOWN', () => {
    assert.equal(canReassignDispatchItem(DispatchItemStatus.SENT), false);
    assert.equal(canReassignDispatchItem(DispatchItemStatus.DELIVERED), false);
    assert.equal(canReassignDispatchItem(DispatchItemStatus.READ), false);
    assert.equal(
      canReassignDispatchItem(DispatchItemStatus.UNKNOWN_PROVIDER_STATE),
      false,
    );
    assert.equal(canReassignDispatchItem(DispatchItemStatus.PENDING), true);
    assert.equal(canReassignDispatchItem(DispatchItemStatus.FAILED), true);
  });
